...
export default function ScaleRow({ value, onChange }: ScaleRowProps) {
  const scales = [
    { value: 1, size: "large" as const, color: "purple" as const },
    { value: 2, size: "medium" as const, color: "purple" as const },
    { value: 3, size: "small" as const, color: "purple" as const },
    { value: 4, size: "small" as const, color: "gray" as const },
    { value: 5, size: "small" as const, color: "green" as const },
    { value: 6, size: "medium" as const, color: "green" as const },
    { value: 7, size: "large" as const, color: "green" as const },
  ];
